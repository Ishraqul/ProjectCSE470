...
<div class="py-5">
  <h2 class="text-center">Our Hotel List</h2>
  </div>
   <div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:  #ADD8E6;">
    <div class="row" style="padding: 5px;">
      <div class="col-md-3"> <b> Hotel Name </b></div>
      <div class="col-md-2"> <b> Hotel Location </b></div>
      <div class="col-md-3"> <b> Hotel email </b></div>
      <div class="col-md-3"> <b> Hotel Phone Number </b></div>
    ...
    <?php
      ...
      <div class="row" style="padding:5px;"> 
        ...
        <div class="col-md-1"> <?php<td>
<td>
                <form action="Delete_hotel.php" method="post">
                  <input type="hidden" name="delete_hotel_name" value="<?php echo $row['hotel_name']; ?>">
    ...
    <div class="text-center">
      <p>
        <a href="insert_hotel_info.php" class ="btn btn-success ">Click Here To ADD Hotel </a>
