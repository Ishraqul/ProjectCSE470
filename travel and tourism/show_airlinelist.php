...
<div class="py-5">
    <h2 class="text-center">Our Airline List</h2>
  </div>
  <div style="margin-left:10%; margin-right:10%; margin-top:50px; margin-bottom:50px;text-align:center;background:  #ADD8E6;">
      <div class="row" style="padding:5px;" > 
        <div class="col-md-1"> <b> Airline ID </b> </div>
        <div class="col-md-2"> <b> Airline Name </b>  </div>
        <div class="col-md-2"> <b> Airline Class </b> </div>
        <div class="col-md-2">  <b> Airline Type</b>  </div>
        <div class="col-md-3">  <b> Number of Seats </b>  </div>
...
<?php 
      ...
      <div class="row" style="padding:5px;"> 
        ...
        <div class="col-md-2">  <?php<td>
            ...
            <td>
                <form action="Delete_airline.php" method="post">
                  <input type="hidden" name="delete_airline_name" value="<?php echo $row['airline_name']; ?>">
    ...
    <div class="text-center">
      <p>
        <a href="insert_airline_info.php" class ="btn btn-success ">Click Here To ADD Airlines </a>
